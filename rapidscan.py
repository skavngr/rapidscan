...
tool_resp   = [
                ...
                ["WordPress Installation Found. Check for vulnerabilities corresponds to that version.","i"],
                ["Drupal Installation Found. Check for vulnerabilities corresponds to that version.","i"],
                ["Joomla Installation Found. Check for vulnerabilities corresponds to that version.","i"],
                ["robots.txt/sitemap.xml found. Check those files for any information.","i"],
                ["No Web Application Firewall Detected","m"],
                ["Some ports are open. Perform a full-scan manually.","l"],
                ...
                ["No DNS/HTTP based Load Balancers Found.","l"],
                ...
                ["DB Banner retrieved with SQLMap.","l"],
...
tools_fix = [
					...
					[7, "Without a Web Application Firewall, An attacker may try to inject various attack patterns either manually or using automated scanners. An autmated scanner may send hordes of attack vectors and patterns to validate an attack, there are also chances for the application to get DoS`ed (Denial of Service)",
